...
```json
{
  ...
  "tiketit": [
    ...
    { "id": 13, "epic": "demo", "nimi": "Demo UI — interaktiivinen vetolappu", "effort": "M", "riippuvuudet": [11], "status": "todo", "acceptance_criteria": ["Käyttäjä voi valita ottelun ja lyödä vetoa (1X2)", "Panoksen syöttö ja validointi (ei yli kassan)", "Vetolappu näyttää avoimet vedot ja mahdollisen voiton", "Vedot tallentuvat localStorageen (säilyy sivun päivityksen yli)"], "valmius": 0 },
